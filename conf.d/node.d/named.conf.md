...
```js
{
    ...
    "servers": [
        ...
        {
            "name": "bind2",
            "url": "https://10.1.2.3:8888/json/v1/server",
            "update_every": 2
        }
    ]
}
